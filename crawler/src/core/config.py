...
RAPIDAPI_AI_TRANSLATE_MIN_INTERVAL_SEC = get_float(
    "RAPIDAPI_AI_TRANSLATE_MIN_INTERVAL_SEC", 4.0
)
RAPIDAPI_GOOGLE_TRANSLATE_MIN_INTERVAL_SEC = get_float(
    "RAPIDAPI_GOOGLE_TRANSLATE_MIN_INTERVAL_SEC", 0.1
)
...
S1_FETCH_MAX_PAGES: int = get_int("S1_FETCH_MAX_PAGES", 30)
