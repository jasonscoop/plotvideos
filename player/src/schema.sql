...
INSERT OR IGNORE INTO settings (key, value, description) VALUES
  ...
  ('ad_watch_top', '', 'HTML: watch page below header, above player'),
  ('ad_watch_related_above', '', 'HTML: above You may also like'),
  ('ad_watch_related_below', '', 'HTML: below You may also like grid');
