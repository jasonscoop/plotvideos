...
def test_get_azure_results():
    ...
    json_file1 = audio.with_suffix(".azure-result-5.json")
    ...
    json_file2.with_suffix(".generated5.vtt").write_text(vtt)
