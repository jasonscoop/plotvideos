...
from src.utils.id_utils import YouJizzIdExtractor, PornhubIdExtractor, EpornerIdExtractor, RedTubeIdExtractor, \
...
@pytest.mark.parametrize("extractor, expected, url", [
    ...
    (EpornerIdExtractor, "gKxXbZQXx8C",
     "https://www.site.com/video-gKxXbZQXx8C/jealousy-and-erection-and-excitement-rental-wife-akemi/"),
    (EpornerIdExtractor, "8oKq73gEcUh",
     "https://www.eporner.com/hd-porn/8oKq73gEcUh/Swinger-Action-Turns-Into-Threesome/"),
    ...
    (XvideosIdExtractor, "ulluaud2445",
    ...
    (YouJizzIdExtractor, "72029002",
     "https://www.youjizz.com/videos/chinese---https%3a%2f%2fstplayer.top%2f---50-min-72029002.html"),
